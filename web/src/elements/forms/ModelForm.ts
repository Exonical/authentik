...
> extends Form<T, D> {
     ...
     * fields out for a spinner would take the user's unsaved input with them. Refreshes reach open
     * forms from anything that changes the object behind their back, such as rotating a secret.
     */
