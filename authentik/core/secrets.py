"""Generation and rotation of the secrets authentik issues itself"""
...
def rotate_secret(instance: Model, field: str, request: HttpRequest | None = None) -> str:
    ...
    The old value stops working immediately. Returns the new value, and records a
    `secret_rotate` event naming the object and the field, never the value itself.
    """
