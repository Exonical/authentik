...
/// User Viewset
pub async fn core_users_list(configuration: &configuration::Configuration, attributes: Option<&str>, date_joined: Option<chrono::DateTime<chrono::FixedOffset>>, date_joined__gt: Option<chrono::DateTime<chrono::FixedOffset>>, date_joined__lt: Option<chrono::DateTime<chrono::FixedOffset>>, email: Option<&str>, groups_by_name: Option<Vec<String>>, groups_by_pk: Option<Vec<uuid::Uuid>>, include_groups: Option<bool>, include_roles: Option<bool>, is_active: Option<bool>, is_superuser: Option<bool>, last_login: Option<chrono::DateTime<chrono::FixedOffset>>, last_login__gt: Option<chrono::DateTime<chrono::FixedOffset>>, last_login__isnull: Option<bool>, last_login__lt: Option<chrono::DateTime<chrono::FixedOffset>>, last_updated: Option<chrono::DateTime<chrono::FixedOffset>>, last_updated__gt: Option<chrono::DateTime<chrono::FixedOffset>>, last_updated__lt: Option<chrono::DateTime<chrono::FixedOffset>>, name: Option<&str>, ordering: Option<&str>, page: Option<i32>, page_size: Option<i32>, path: Option<&str>, path_startswith: Option<&str>, roles_by_name: Option<Vec<String>>, roles_by_pk: Option<Vec<uuid::Uuid>>, search: Option<&str>, r#type: Option<Vec<models::UserTypeEnum>>, username: Option<&str>, uuid: Option<&str>) -> Result<models::PaginatedUserList, Error<CoreUsersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_attributes = attributes;
