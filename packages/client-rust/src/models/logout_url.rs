...
pub struct LogoutUrl {
    ...
    #[serde(rename = "saml_request", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub saml_request: Option<Option<String>>,
    #[serde(rename = "saml_response", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub saml_response: Option<Option<String>>,
    #[serde(rename = "saml_relay_state", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
