...
impl PaginatedProxyOutpostConfigList {
    pub fn new(pagination: models::Pagination, results: Vec<models::ProxyOutpostConfig>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedProxyOutpostConfigList {
