...
impl AuthenticatorValidationChallenge {
    ...
    pub fn new(pending_user: String, pending_user_avatar: String, device_challenges: Vec<models::DeviceChallenge>, configuration_stages: Vec<models::SelectableStage>) -> AuthenticatorValidationChallenge {
