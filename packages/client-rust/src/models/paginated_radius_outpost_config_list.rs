...
impl PaginatedRadiusOutpostConfigList {
    pub fn new(pagination: models::Pagination, results: Vec<models::RadiusOutpostConfig>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedRadiusOutpostConfigList {
