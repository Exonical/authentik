...
impl UserSelf {
    ...
    pub fn new(pk: i32, username: String, name: String, is_active: bool, is_superuser: bool, is_current: bool, groups: Vec<models::UserSelfGroups>, roles: Vec<models::UserSelfRoles>, avatar: String, uid: String, settings: std::collections::HashMap<String, serde_json::Value>, system_permissions: Vec<String>) -> UserSelf {
        UserSelf {
            pk,
            username,
            name,
