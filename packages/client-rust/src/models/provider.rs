...
pub struct Provider {
    ...
    #[serde(rename = "invalidation_flow", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
