...
impl User {
    /// User Serializer
    pub fn new(pk: i32, username: String, name: String, date_joined: chrono::DateTime<chrono::FixedOffset>, is_superuser: bool, groups_obj: Option<Vec<models::PartialGroup>>, roles_obj: Option<Vec<models::Role>>, avatar: String, uid: String, uuid: uuid::Uuid, password_change_date: chrono::DateTime<chrono::FixedOffset>, last_updated: chrono::DateTime<chrono::FixedOffset>) -> User {
        User {
            pk,
            username,
            name,
