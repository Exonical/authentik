...
impl PaginatedLdapOutpostConfigList {
    pub fn new(pagination: models::Pagination, results: Vec<models::LdapOutpostConfig>, autocomplete: std::collections::HashMap<String, serde_json::Value>) -> PaginatedLdapOutpostConfigList {
