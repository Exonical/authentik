...
impl StagePrompt {
    ...
    pub fn new(field_key: String, label: String, r#type: models::PromptTypeEnum, required: bool, placeholder: String, initial_value: String, order: i32, sub_text: String, choices: Option<Vec<models::PromptChoice>>) -> StagePrompt {
        StagePrompt {
            field_key,
            label,
            r#type,
