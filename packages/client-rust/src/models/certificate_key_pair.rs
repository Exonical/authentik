...
impl CertificateKeyPair {
    ...
    pub fn new(pk: uuid::Uuid, name: String, fingerprint_sha256: Option<String>, fingerprint_sha1: Option<String>, cert_expiry: Option<chrono::DateTime<chrono::FixedOffset>>, cert_subject: Option<String>, private_key_available: bool, key_type: Option<models::CertificateKeyPairKeyTypeEnum>, certificate_download_url: String, private_key_download_url: String, managed: Option<String>) -> CertificateKeyPair {
        CertificateKeyPair {
            pk,
            name,
            fingerprint_sha256,
